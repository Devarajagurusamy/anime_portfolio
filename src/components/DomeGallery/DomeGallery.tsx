...
function buildItems(pool: (string | DomeImageItem)[], seg: number) {
  ...
  const normalizedImages: DomeImageItem[] = pool.map(image => {
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const close = () => {
      ...
      const rootRect = (rootRef.current as HTMLElement).getBoundingClientRect();
